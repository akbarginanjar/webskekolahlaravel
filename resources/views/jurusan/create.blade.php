                ...
                <form action="{{ route('jurusan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('kode_jurusan') }}" name="kode_jurusan" type="text" placeholder="Kode Jurusan">
                        @error('kode_jurusan')
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('nama_jurusan') }}" name="nama_jurusan" type="text" placeholder="Nama Jurusan">
                        @error('nama_jurusan')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('kapasitas_jurusan') }}" name="kapasitas_jurusan" type="text"
